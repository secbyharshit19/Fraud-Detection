...
def train_model(X_train: pd.DataFrame, y_train: pd.Series, params: Dict[str, Any]) -> LGBMClassifier:
    """Trains a LightGBM classifier with the given parameters."""
...
def save_model(model: LGBMClassifier, path: str, metadata: Dict[str, Any]) -> None:
...
def run_pipeline() -> None:
    ...
    model_save_path = repo_root / "models" / "trained" / "lightgbm_v1.pkl"
