...
def train_model(X_train: pd.DataFrame, y_train: pd.Series, params: Dict[str, Any]) -> RandomForestClassifier:
    """Trains a RandomForest classifier with the given parameters."""
...
def save_model(model: RandomForestClassifier, path: str, metadata: Dict[str, Any]) -> None:
...
def run_pipeline() -> None:
    ...
    model_save_path = repo_root / "models" / "trained" / "random_forest_v1.pkl"
